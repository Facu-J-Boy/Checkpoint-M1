...
function crearClasePersona() {
  class Persona {
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var map = this.amigos.map (element => element.edad);
      var reduce = map.reduce ((PreviousValue, CurrentValue) => PreviousValue + CurrentValue);
      return reduce / this.amigos.length;
  }
};
return Persona;
}
